...
// sources:
// ../manifests/0000_31_cluster-hosted-operator_06_clusteroperator.cr.yaml
package controllers
...
var _bindata = map[string]func() (*asset, error){
	"../manifests/0000_31_cluster-hosted-operator_06_clusteroperator.cr.yaml": Manifests0000_31_clusterHostedOperator_06_clusteroperatorCrYaml,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"..": {nil, map[string]*bintree{
		"manifests": {nil, map[string]*bintree{
			"0000_31_cluster-hosted-operator_06_clusteroperator.cr.yaml": {Manifests0000_31_clusterHostedOperator_06_clusteroperatorCrYaml, map[string]*bintree{}},
		}},
	}},
}}

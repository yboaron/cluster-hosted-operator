...
//go:generate go run -mod=vendor ../vendor/github.com/go-bindata/go-bindata/go-bindata/ -nometadata -pkg $GOPACKAGE -ignore=bindata.go  ../manifests/0000_31_cluster-hosted-operator_06_clusteroperator.cr.yaml
...
const (
	clusterOperatorName = "cluster-hosted-net-services"
...
func (r *ConfigReconciler) createClusterOperator() (*osconfigv1.ClusterOperator, error) {
	b, err := Asset("../manifests/0000_31_cluster-hosted-operator_06_clusteroperator.cr.yaml")
	if err != nil {
		return nil, err
	}
...
func (r *ConfigReconciler) ensureClusterOperator(clusterHostedConfig *clusterstackv1beta1.Config) error {
